    ...
    public partial class SearchInternet_frm : Form
    {
        ...
        private void buttonItem_ieSearch_Click(object sender, EventArgs e)
        {
            if (Global_Cls.SetConnection())
                ...
                else Global_Cls.Message_Sara(0, Global_Cls.MessageType.SWarning, false, " متن را وارد نمایید");
        }
        ...
        private void SearchInternetFunc(string s_unicode, int SearchEngin)
        {
            ...
            {
                Global_Cls.Message_Sara(0, Global_Cls.MessageType.SError, false, " برنامه اینترنت اکسپلور نصب نمی باشد!");
            }
        }
